...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-white border-b border-gray-100 w-full">
      ...
      <div className="hidden md:block bg-gray-50 text-gray-600 py-3 border-b border-gray-100">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              <div className="text-xl lg:text-3xl font-light text-gray-900 tracking-wider">
                SafawiNet
              </div>
            </Link>
          </div>
          ...
          <nav className="hidden lg:flex items-center space-x-8 xl:space-x-12">
            <AnimatedLink to="/" className="text-gray-700 hover:text-red-500 transition-colors duration-200 font-light text-sm tracking-wide uppercase">
              Home
            </AnimatedLink>
            <AnimatedLink to="/about" className="text-gray-700 hover:text-red-500 transition-colors duration-200 font-light text-sm tracking-wide uppercase">
              About
            </AnimatedLink>
            <AnimatedLink to="/products" className="text-gray-700 hover:text-red-500 transition-colors duration-200 font-light text-sm tracking-wide uppercase">
              Products
            </AnimatedLink>
            <AnimatedLink to="/services" className="text-gray-700 hover:text-red-500 transition-colors duration-200 font-light text-sm tracking-wide uppercase">
              Services
            </AnimatedLink>
            <AnimatedLink to="/support" className="text-gray-700 hover:text-red-500 transition-colors duration-200 font-light text-sm tracking-wide uppercase">
              Support
            </AnimatedLink>
            <AnimatedLink to="/contact" className="text-gray-700 hover:text-red-500 transition-colors duration-200 font-light text-sm tracking-wide uppercase">
              Contact
            </AnimatedLink>
          </nav>
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <div className="relative" ref={langDropdownRef}>
              <AnimatedButton
                ...
                className="flex items-center space-x-2 px-4 py-2 text-gray-600 hover:text-red-500 transition-colors duration-200 rounded-none border-b border-transparent hover:border-red-500"
              >
              ...
              {isLangOpen && (
                <div className="absolute right-0 mt-2 w-40 bg-white rounded-none shadow-lg border border-gray-100 z-50 language-dropdown">
                  <div className="py-1">
                    {languages.map((lang) => (
                      <button
                        key={lang.value}
                        className="w-full text-left px-4 py-3 text-sm text-gray-600 hover:text-red-500 hover:bg-gray-50 transition-colors duration-200 font-light"
                        onClick={() => {
            ...
            <div className="relative" ref={currencyDropdownRef}>
              ...
              {isCurrencyOpen && (
                <div className="absolute right-0 mt-2 w-40 bg-white rounded-none shadow-lg border border-gray-100 z-50 currency-dropdown">
                  <div className="py-1">
        ...
        >
          <form className="w-full">
            <div className="relative">
              <div className="flex items-stretch bg-white shadow-lg border border-gray-200 overflow-hidden">
                {/* Categories Select */}
                ...
                <input
                  ...
                  className="flex-1 px-4 py-2 text-sm font-light text-gray-700 placeholder-gray-400 focus:outline-none min-w-0"
                ...
                <AnimatedButton
                  type="submit"
                  className="flex-shrink-0 px-4 py-3 bg-gray-800 hover:bg-gray-700 text-white transition-colors duration-200 focus:outline-none flex items-center justify-center min-w-[40px]"
                  aria-label="Search"
                >
        ...
        <div className="w-full max-w-7xl mx-auto px-4 lg:px-6 py-4 lg:py-6">
          <div className="flex items-center justify-between space-x-4 lg:space-x-8">
            ...
            <form className="flex-1 max-w-2xl mx-4 lg:mx-8">
              <div className="relative">
                <div className="flex items-center bg-white shadow-lg border border-gray-200 overflow-hidden">
                  {/* Categories Select */}
                  ...
                  <input
                    ...
                    className="flex-1 px-4 py-2 text-sm font-light text-gray-700 placeholder-gray-400 focus:outline-none"
                    aria-label="Search products"
                  />
                  ...
                  <button
                    type="submit"
                    className="px-4 py-3.5 bg-gray-800 hover:bg-gray-700 text-white transition-colors duration-200 focus:outline-none"
                    aria-label="Search"
                  >
                    <HiSearch className="w-5 h-5" />
                  </button>
      ...
      {/* Mobile Menu */}
      <div
        className={`lg:hidden fixed inset-0 z-50 bg-white w-full transition-all duration-300 ease-in-out mobile-menu ${isMenuOpen
        ...
        <div className="h-full overflow-y-auto w-full">
          ...
          <div className="px-4 py-6 space-y-2 w-full">
            ...
            <div className="space-y-1">
              <AnimatedLink
                to="/"
                className="block px-4 py-3 text-gray-700 hover:text-red-500 hover:bg-gray-50 transition-colors duration-200 font-light rounded-lg"
                onClick={() => setIsMenuOpen(false)}
              >
                Home
              </AnimatedLink>
            ...
            <div className="border-t border-gray-100 pt-6 mt-6">
              <div className="text-sm font-medium text-gray-500 mb-4 px-4">Quick Links</div>
              <div className="space-y-1">
                <AnimatedLink
                  to="/new-arrivals"
                  className="block px-4 py-3 text-gray-700 hover:text-red-500 hover:bg-gray-50 transition-colors duration-200 font-light rounded-lg"
            ...
            <div className="border-t border-gray-100 pt-6 mt-6">
              <div className="text-sm font-medium text-gray-500 mb-4 px-4">Account</div>
              <div className="space-y-1">
                {isAuthenticated ? (
                  <>
                    <div className="px-4 py-3 text-gray-700 font-light">
                    ...
                    <button
                      ...
                      className="block w-full text-left px-4 py-3 text-gray-700 hover:text-red-500 hover:bg-gray-50 transition-colors duration-200 font-light rounded-lg flex items-center"
                    >
                      <HiLogout className="w-4 h-4 mr-2" />
                      Sign Out
                    </button>
            ...
            {/* Mobile Preferences */}
            <div className="border-t border-gray-100 pt-6 mt-6">
              <div className="text-sm font-medium text-gray-500 mb-4 px-4">Preferences</div>

              {/* Mobile Language */}
              <div className="px-4 py-3">
                <div className="flex items-center justify-between">
                  <span className="text-gray-700 font-light">Language</span>
                  <Select
                    options={languages}
              ...
              <div className="px-4 py-3">
                <div className="flex items-center justify-between">
                  <span className="text-gray-700 font-light">Theme</span>
                  <AnimatedButton
                    onClick={toggleTheme}
              ...
              <div className="px-4 py-3">
                <div className="flex items-center justify-between">
                  <span className="text-gray-700 font-light">Currency</span>
                  <Select
                    options={currencies}
