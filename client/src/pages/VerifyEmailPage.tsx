            ...
            <div className="max-w-7xl mx-auto">
                ...
                <nav className="mb-12">
                    <ol className="flex items-center space-x-3 text-sm text-gray-500 font-light">
                        ...
                        <li className="text-gray-900 font-light">Email Verification</li>
                    </ol>
                </nav>
                    ...
                    <div className="p-12 lg:p-16">
                        <div className="max-w-2xl mx-auto text-center">
                            ...
                            {verificationState === 'success' && (
                                <div className="mb-8">
                                    <div className="inline-block mb-4">
                                        <span className="text-green-500 text-sm font-light tracking-widest uppercase border-b border-green-200 pb-2">
                                            Success
                                        </span>
                                    </div>
                                    <div className="mb-6">
                                    ...
                                    <button
                                        ...
                                        className="bg-transparent border border-gray-300 text-gray-900 py-3 px-8 font-light tracking-wide hover:border-red-500 hover:text-red-500 transition-all duration-300"
                                    >
                                        Go to Home Page Now
                                    </button>
                                </div>
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="space-y-4">
                                        <button
                                            ...
                                            className="w-full bg-transparent border border-gray-300 text-gray-900 py-3 px-8 font-light tracking-wide hover:border-red-500 hover:text-red-500 transition-all duration-300"
                                        >
                                            Go to My Account
                                        </button>
                                        <button
