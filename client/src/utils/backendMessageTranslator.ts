...
const messageMappings: Record<string, string> = {
  ...
  'User with this email already exists': 'backendMessages.registration.emailAlreadyExists',
  'User with this already exists': 'backendMessages.registration.emailAlreadyExists',
  'Email already exists': 'backendMessages.registration.emailAlreadyExists',
  'This email is already registered': 'backendMessages.registration.emailAlreadyExists',
  'Email is already in use': 'backendMessages.registration.emailAlreadyExists',
  'This username is already taken': 'backendMessages.registration.usernameAlreadyExists',
  'Username already exists': 'backendMessages.registration.usernameAlreadyExists',
  'Username is already taken': 'backendMessages.registration.usernameAlreadyExists',
  ...
  'Invalid input': 'backendMessages.general.validationError',
  'Invalid data': 'backendMessages.general.validationError',
  'Missing required fields': 'backendMessages.general.validationError',
  'Required field missing': 'backendMessages.general.validationError',
  'Field is required': 'backendMessages.general.validationError',
  'Invalid format': 'backendMessages.general.validationError',
  'Invalid request': 'backendMessages.general.validationError',
  'Bad request': 'backendMessages.general.validationError',
  'Request failed': 'backendMessages.general.serverError',
  'Operation failed': 'backendMessages.general.serverError',
  'Something went wrong': 'backendMessages.general.serverError',
  'An error occurred': 'backendMessages.general.serverError',
  'Please try again': 'backendMessages.general.serverError',
  'Try again later': 'backendMessages.general.serverError',
  'Service unavailable': 'backendMessages.general.maintenanceMode',
  'Temporarily unavailable': 'backendMessages.general.maintenanceMode',
  'Rate limit exceeded': 'backendMessages.general.tooManyAttempts',
  'Request limit exceeded': 'backendMessages.general.tooManyAttempts',
};
