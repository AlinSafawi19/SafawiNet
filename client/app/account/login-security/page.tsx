...
export default function LoginSecurityPage() {
    ...
    const securityQuestions = [
        {
            id: 'password',
            question: t('account.loginSecurity.questions.password.question'),
            action: t('account.loginSecurity.questions.password.action'),
            href: '/account/login-security/password'
        },
        {
            id: '2fa',
            question: t('account.loginSecurity.questions.2fa.question'),
            action: t('account.loginSecurity.questions.2fa.action'),
            href: '/account/login-security/2fa'
        },
        {
            id: 'name',
            question: t('account.loginSecurity.questions.name.question'),
            action: t('account.loginSecurity.questions.name.action'),
                            ...
                            >
                                <div className="flex flex-col h-full">
                                    ...
                                    <div className="mt-auto">
                                        ...
                                        >
                                            <span className={locale === 'ar' ? 'text-right' : 'text-left'}>{question.action}</span>
